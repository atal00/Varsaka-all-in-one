  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Generated Case Studies</h1>
          <p className="text-gray-600 dark:text-gray-400">View and manage your AI-generated deep research case studies.</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-sm border border-gray-200 dark:border-zinc-800 overflow-hidden">
        {caseStudies.length === 0 ? (
          <div className="p-12 text-center text-gray-500 dark:text-gray-400">
            No case studies generated yet. Go to Topics to generate one!
          </div>
        ) : (
          <table className="min-w-full divide-y divide-gray-200 dark:divide-zinc-800">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-zinc-800">
              {caseStudies.map((caseStudy: any) => (
                <tr key={caseStudy.id} className="hover:bg-gray-50 dark:hover:bg-zinc-800/50 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <Briefcase className="w-5 h-5 text-blue-500 mr-3" />
                      <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{caseStudy.title}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <Link href={`/dashboard/case-studies/${caseStudy.id}`} className="inline-flex items-center text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
